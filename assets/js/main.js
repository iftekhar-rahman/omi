	...
	***********************/ 
	...
	function cartDrpdownExpand(){
		$('#cartDropdown').on('click', function(e){
			e.preventDefault();
			e.stopPropagation();
			$(this).siblings('.mini-cart__dropdown-menu').addClass('open').slideToggle('slow');
			if($('.dropdown-menu').hasClass('show')){
				$('.dropdown-menu').removeClass('show').slideUp('slow');
			}
		});
		$('#cart-close').on('click', function(e){
			e.preventDefault();
			$('.mini-cart__dropdown-menu').removeClass('open').slideUp('slow');
		})
		...
		$('.dropdown-toggle').on('click', function(){
			if($('.mini-cart__dropdown-menu').hasClass('open')){
				$('.mini-cart__dropdown-menu').slideUp('slow');
			}
		});
	}
